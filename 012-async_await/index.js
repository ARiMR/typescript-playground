...
var generateIncrementNumberPromise = function (value) {
...
var simplePromiseResolve = function () {
    console.log('simplePromiseResolve function START');
    generateIncrementNumberPromise(42).then(function (value) {
        console.log("simsimplePromiseResolve: resolved " + value);
        generateIncrementNumberPromise(value).then(function (value) {
            console.log("simsimplePromiseResolve: resolved " + value);
            generateIncrementNumberPromise(value).then(function (value) {
                console.log("simsimplePromiseResolve: resolved " + value);
            });
...
// ------------------------------------------------------------------------------------------------------------------ //
var asyncAwaitPromiseResolve = function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, generateIncrementNumberPromise(42)];
                case 1:
                    value = _a.sent();
                    console.log("asyncAwaitPromiseResolve: resolved " + value);
                    return [4 /*yield*/, generateIncrementNumberPromise(value)];
                case 2:
                    value = _a.sent();
                    console.log("asyncAwaitPromiseResolve: resolved " + value);
                    return [4 /*yield*/, generateIncrementNumberPromise(value)];
